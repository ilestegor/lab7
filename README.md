...
- [ ] [Add files using the stuff.command line](https://docs.gitlab.com/ee/gitlab-basics/add-file.html#add-a-file-using-the-command-line)
  or push an existing Git repository with the following stuff.command:

```
cd existing_repo
git remote add origin https://gitlab.com/itmo_programming_2023/p3132/student-6.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/itmo_programming_2023/p3132/student-6/-/settings/integrations)
